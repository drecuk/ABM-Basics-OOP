...
bool Grid::isInBoundary(Vector3f pos, float buffer)
{
	...
	if (((pos.x > _left + buffer) && (pos.x < _right - buffer)) == false)
		cout<<"exited left and right "<<pos.x<<","<<pos.z<<","<<endl;

	if (((pos.z > _top + buffer) && (pos.z < _bottom - buffer)) == false)
		cout<<"exited top and bottom "<<pos.x<<","<<pos.z<<","<<endl;
