...
//
//  This 'debugging' program demonstrates how agent field of view (FOV)
//  can be implemented with some formula and algorithms
//  the program also tests if the 'prey' is on the left or on the right
//  of the agent, thus allowing autonomous agents to steer left or right
//  in predator-prey simulations
//
//  ----------------------------------------------------------
//  How to compile:
//  note that we are now using both SDL2 and OpenGL, thus the -l for all libraries
//  we are also using multiple cpp files
//  sudo g++ -I/usr/include/ main.cpp Moveable.cpp Grid.cpp -o main -L/usr/lib -lSDL2 -lGL -lGLU
//
...
int main(int argc, char**argv)
{
    ...
    creature = new Moveable(1, 0, 0, 0, 0.001f);
