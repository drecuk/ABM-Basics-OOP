...
//
//  Creating a simple terrain and putting an agent on it
//  Extended Moveable as MoveableOnTerrain, implementing
//  moving on the surfaces (planes, normals) of SimpleTerrain
//
//  ----------------------------------------------------------
//  How to compile:
//  note that we are now using both SDL2 and OpenGL, thus the -l for all libraries
//  we are also using multiple cpp files
//  sudo g++ -I/usr/include/ main.cpp Camera.cpp SimpleTerrain.cpp MoveableOnTerrain.cpp Grid.cpp -o main -L/usr/lib -lSDL2 -lGL -lGLU
//
...
int main(int argc, char**argv)
{
    ...
    terrain = new SimpleTerrain(4, 4, 1.0f, 25.0f);

    cout<<"*********************** Initialising Object ***********************"<<endl;
    moveable = new MoveableOnTerrain(1, 0, 0, 0, 0.001f);
